...
function addListener(func) {
    ...
    if (func instanceof (Array)) { // if it's an array, add all the functions to listeners variable
...
function removeListener(func) {
    ...
    if (func instanceof (Array)) { // if it's an array, remove all the functions found in listeners variable
        for (var i = 0; i < func.length; i++) {
